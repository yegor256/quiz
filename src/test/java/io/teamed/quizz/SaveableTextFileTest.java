...
public class SaveableTextFileTest extends AbstractTextFileTest {
  ...
  public void shouldWriteFile() throws IOException {
    ...
    final SaveableTextFile newText = newText(tmp.toPath(), UTF_8);
  ...
  @Override
  protected SaveableTextFile newText(final Path path, final Charset charset) {
    return new SaveableTextFile(path, charset);
  }
